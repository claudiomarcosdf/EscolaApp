...
import ModalRegisterStudent from './RegisterStudent';
import { visibleModal } from '../../views/Student/Modal/modalActions';
...
export default function StudentProfile(props) {
  ...
  return (
    <div>
      ...
      {modal.visible && <ModalRegisterStudent onClose={handleCloseModal} />}
    </div>
  );
}
