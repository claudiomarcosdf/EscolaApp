...
export const ADD_STUDENT_AVATAR_REQUEST = 'ADD_STUDENT_AVATAR_REQUEST';
export const ADD_STUDENT_AVATAR_SUCCESS = 'ADD_STUDENT_AVATAR_SUCCESS';
export const ADD_STUDENT_AVATAR_FAILURE = 'ADD_STUDENT_AVATAR_FAILURE';
